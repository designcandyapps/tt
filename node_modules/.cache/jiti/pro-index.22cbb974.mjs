...
var _defu = await jitiImport("defu");var _default = exports.default =
...
(0, _kit.defineNuxtModule)({
  ...
  setup(options, nuxt) {
    const resolver = (0, _kit.createResolver)("file:///Users/dhanrajchakravarti/Projects/cs/tt/node_modules/@nuxt/ui-pro/modules/pro/index.ts");
